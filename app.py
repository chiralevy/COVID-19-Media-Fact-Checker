...
"""
# RCNN Fake News Classifier 
This is a simple classifier. It takes in an article and tells you if the article is fake news or not. It was trained on a data set including articles of real and fake news. 
...
if option == "General News":
    ...
    # Predict based on the URL
    covid_predict(url, covid_inference)
